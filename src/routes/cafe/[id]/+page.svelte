<script>
  ...
  // Data artikel cafe berdasarkan ID
  const cafeData = {
    1: {
      id: 1,
      title: 'Kopi Terbaik di Kelantan - 15 Coffee Shop Wajib Coba',
      category: 'CAFE',
      author: 'OMNY',
      date: 'APRIL 26, 2023',
      content: `
        <p class="mb-6 text-lg leading-relaxed">
          <span class="text-4xl font-serif text-primary-500 float-left mr-3 mt-1">K</span>
          opi adalah bagian tak terpisahkan dari budaya Malaysia, dan Kelantan memiliki scene kopi yang berkembang pesat dengan berbagai coffee shop yang menawarkan pengalaman unik.
        </p>
      `,
      mainImage: 'https://images.unsplash.com/photo-1504674900240-9a9049b7d8ce?w=800&h=500&fit=crop',
      embeddedImage1: 'https://images.unsplash.com/photo-1504674900240-9a9049b7d8ce?w=400&h=300&fit=crop',
      embeddedImage2: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400&h=300&fit=crop'
    }
  };

  // Ambil ID dari URL
  $: articleId = $page.params.id;
  $: article = cafeData[articleId] || cafeData[1];
</script>
  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <nav class="mb-6">
      <ol class="flex items-center space-x-2 text-sm text-gray-600">
        ...
        <li><a href="/cafe" class="hover:text-primary-500 transition-colors">Cafe</a></li>
        <li class="text-gray-400">/</li>
