<script>
  ...
  // Data artikel recipe berdasarkan ID
  const recipeData = {
    1: {
      id: 1,
      title: 'Resep Nasi Lemak Terbaik - Masakan Tradisional Malaysia',
      category: 'RECIPE',
      author: 'OMNY',
      date: 'APRIL 26, 2023',
      content: `
        <p class="mb-6 text-lg leading-relaxed">
          ...
          asi Lemak adalah hidangan nasional Malaysia yang terdiri dari nasi yang dimasak dengan santan, disajikan dengan berbagai lauk pauk seperti ayam goreng, telur, kacang, dan sambal. Hidangan ini memiliki cita rasa yang unik dan berbeda dari daerah lain.
        </p>
      `,
  ...
  $: article = recipeData[articleId] || recipeData[1];
</script>
  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <nav class="mb-6">
      <ol class="flex items-center space-x-2 text-sm text-gray-600">
        ...
        <li><a href="/recipe" class="hover:text-primary-500 transition-colors">Recipe</a></li>
        <li class="text-gray-400">/</li>
