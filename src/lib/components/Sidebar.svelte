...
<div class="space-y-8">
  <!-- About Me -->
  <div class="bg-gradient-to-br from-white to-orange-50 p-6 rounded-2xl shadow-xl border border-orange-100 transform hover:scale-105 transition-all duration-300">
    ...
    <div class="flex justify-center space-x-3">
      <a href="#" class="w-10 h-10 bg-gradient-to-r from-red-600 to-orange-600 rounded-full flex items-center justify-center hover:from-red-700 hover:to-orange-700 transition-all duration-300 transform hover:scale-110 shadow-lg">
  ...
  <!-- Recent Posts -->
  <div class="bg-gradient-to-br from-white to-red-50 p-6 rounded-2xl shadow-xl border border-red-100 transform hover:scale-105 transition-all duration-300">
        ...
        <article class="flex items-start space-x-3 group">
          <div class="flex-shrink-0">
            <img 
              ...
              alt={article.title}
              class="w-16 h-16 object-cover rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-105"
            />
          </div>
